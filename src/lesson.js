...
class LessonStore {
  static getLessonCategories() {
    return [
      {
        id: "basic",
        name: "200 Basic Vocabularies",
        description: "Foundation vocabulary for beginners",
        subLessons: [
          {
            id: "1",
          ...
          },
          {
            ...
            description:
              "Learn verbs for social interactions and communication.",
            vocabularies: [
              {
                id: "1501",
                type: "verb",
        ...
        subLessons: [
          {
            ...
            description: "Formal vocabulary for academic papers and essays",
            vocabularies: [],
          },
          {
            id: "b2-2",
            name: "Research Methods",
            description: "Terms related to conducting and analyzing research",
            vocabularies: [],
          },
          {
            id: "b2-3",
            ...
            description:
              "Vocabulary for business administration and leadership",
            vocabularies: [],
          },
          {
            id: "b2-4",
            name: "Financial Markets",
            description: "Terms related to stocks, investments and trading",
            vocabularies: [],
          },
          {
            id: "b2-5",
            name: "Marketing Strategy",
            description: "Advanced marketing and advertising terminology",
            vocabularies: [],
          },
          {
            id: "b2-6",
            name: "Information Technology",
            description: "Computer systems and software development terms",
            vocabularies: [],
          },
          {
            id: "b2-7",
            name: "Artificial Intelligence",
            description: "AI, machine learning and automation vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-8",
            name: "Climate Change",
            description: "Environmental science and climate terminology",
            vocabularies: [],
          },
          {
            id: "b2-9",
            name: "Renewable Energy",
            description: "Sustainable energy and green technology terms",
            vocabularies: [],
          },
          {
            id: "b2-10",
            name: "Political Systems",
            description: "Government structures and political processes",
            vocabularies: [],
          },
          {
            id: "b2-11",
            name: "International Relations",
            description: "Diplomacy and global affairs vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-12",
            name: "Social Media",
            description: "Digital communication and social networking terms",
            vocabularies: [],
          },
          {
            id: "b2-13",
            name: "Journalism",
            description: "News reporting and media production vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-14",
            name: "Fine Arts",
            description: "Visual arts and artistic techniques terminology",
            vocabularies: [],
          },
          {
            id: "b2-15",
            name: "Classical Music",
            description: "Musical theory and composition vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-16",
            name: "Theater Arts",
            description: "Stage performance and dramatic arts terms",
            vocabularies: [],
          },
          {
            id: "b2-17",
            name: "Film Production",
            description: "Cinema and movie-making terminology",
            vocabularies: [],
          },
          {
            id: "b2-18",
            name: "Psychology",
            description: "Mental processes and behavioral terms",
            vocabularies: [],
          },
          {
            id: "b2-19",
            name: "Sociology",
            description: "Social structures and human society vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-20",
          ...
          },
          {
            id: "b2-21",
            name: "Public Health",
            description: "Community health and epidemiology terms",
            vocabularies: [],
          },
          {
            id: "b2-22",
            name: "Biology",
            description: "Life sciences and biological systems vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-23",
            name: "Chemistry",
            description: "Chemical compounds and reactions terminology",
            vocabularies: [],
          },
          {
            id: "b2-24",
            name: "Physics",
            description: "Physical sciences and natural laws vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-25",
            name: "Astronomy",
            description: "Space science and celestial objects terms",
            vocabularies: [],
          },
          {
            id: "b2-26",
            name: "Geography",
            description: "Physical features and earth science terminology",
            vocabularies: [],
          },
          {
            id: "b2-27",
            name: "Urban Planning",
            description: "City development and infrastructure terms",
            vocabularies: [],
          },
          {
            id: "b2-28",
            name: "Architecture",
            description: "Building design and construction vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-29",
            name: "Engineering",
            description: "Technical and mechanical engineering terms",
            vocabularies: [],
          },
          {
            id: "b2-30",
            name: "Agriculture",
            description: "Farming and crop production terminology",
            vocabularies: [],
          },
          {
            id: "b2-31",
            name: "Food Science",
            description: "Nutrition and food processing vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-32",
            name: "Sports Science",
            description: "Athletic performance and training terms",
            vocabularies: [],
          },
          {
            id: "b2-33",
            name: "Education",
            description: "Teaching methods and learning theory vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-34",
            name: "Law",
            description: "Legal systems and jurisprudence terminology",
            vocabularies: [],
          },
          {
            id: "b2-35",
            name: "Criminal Justice",
            description: "Law enforcement and criminal law terms",
            vocabularies: [],
          },
          {
            id: "b2-36",
            name: "Philosophy",
            description: "Philosophical concepts and reasoning vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-37",
            name: "Ethics",
            description: "Moral principles and ethical reasoning terms",
            vocabularies: [],
          },
          {
            id: "b2-38",
            name: "Religion",
            description: "Religious studies and spiritual concepts vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-39",
            name: "Anthropology",
            description: "Human cultures and societies terminology",
            vocabularies: [],
          },
          {
            id: "b2-40",
            name: "Archaeology",
            description: "Ancient civilizations and excavation terms",
            vocabularies: [],
          },
          {
            id: "b2-41",
            name: "History",
            description: "Historical events and historiography vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-42",
            name: "Literature",
            description: "Literary analysis and criticism terminology",
            vocabularies: [],
          },
          {
            id: "b2-43",
            name: "Linguistics",
            description: "Language structure and analysis terms",
            vocabularies: [],
          },
          {
            id: "b2-44",
            name: "Translation",
            description: "Language interpretation and translation vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-45",
            name: "Fashion Design",
            description: "Clothing design and textile terminology",
            vocabularies: [],
          },
          {
            id: "b2-46",
            name: "Interior Design",
            description: "Space planning and decoration terms",
            vocabularies: [],
          },
          {
            id: "b2-47",
            name: "Graphic Design",
            description: "Visual communication and typography vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-48",
            name: "Industrial Design",
            description: "Product design and manufacturing terms",
            vocabularies: [],
          },
          {
            id: "b2-49",
            name: "Photography",
            description: "Camera techniques and image processing vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-50",
            name: "Digital Art",
            description: "Computer-generated art and digital media terms",
            vocabularies: [],
          },
          {
            id: "b2-51",
            name: "Dance",
            description: "Movement arts and choreography terminology",
            vocabularies: [],
          },
          {
            id: "b2-52",
            name: "Tourism",
            description: "Travel industry and hospitality vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-53",
            name: "Event Planning",
            description: "Event management and coordination terms",
            vocabularies: [],
          },
          {
            id: "b2-54",
            name: "Human Resources",
            description: "Personnel management and workplace terminology",
            vocabularies: [],
          },
          {
            id: "b2-55",
            name: "Project Management",
            description: "Project planning and execution vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-56",
            name: "Quality Management",
            description: "Quality control and assurance terms",
            vocabularies: [],
          },
          {
            id: "b2-57",
            name: "Supply Chain",
            description: "Logistics and distribution terminology",
            vocabularies: [],
          },
          {
            id: "b2-58",
            name: "Real Estate",
            description: "Property management and real estate terms",
            vocabularies: [],
          },
          {
            id: "b2-59",
            name: "Insurance",
            description: "Insurance products and risk management vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-60",
            name: "Banking",
            description: "Banking services and financial operations terms",
            vocabularies: [],
          },
          {
            id: "b2-61",
            name: "Accounting",
            description: "Financial accounting and auditing terminology",
            vocabularies: [],
          },
          {
            id: "b2-62",
            name: "Taxation",
            description: "Tax law and fiscal policy vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-63",
            name: "Economics",
            description: "Economic theory and market analysis terms",
            vocabularies: [],
          },
          {
            id: "b2-64",
            name: "International Trade",
            description: "Global commerce and trade policy vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-65",
            name: "Entrepreneurship",
            description: "Business startup and innovation terminology",
            vocabularies: [],
          },
          {
            id: "b2-66",
            name: "E-commerce",
            description: "Online business and digital retail terms",
            vocabularies: [],
          },
          {
            id: "b2-67",
            name: "Digital Marketing",
            description: "Online marketing and SEO vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-68",
            name: "Data Science",
            description: "Data analysis and statistics terminology",
            vocabularies: [],
          },
          {
            id: "b2-69",
            name: "Cybersecurity",
            description: "Information security and cyber defense terms",
            vocabularies: [],
          },
          {
            id: "b2-70",
            name: "Cloud Computing",
            description: "Cloud services and virtualization vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-71",
            name: "Mobile Technology",
            description: "Mobile devices and app development terms",
            vocabularies: [],
          },
          {
            id: "b2-72",
            name: "Robotics",
            description: "Robot design and automation terminology",
            vocabularies: [],
          },
          {
            id: "b2-73",
            name: "Biotechnology",
            description: "Genetic engineering and biotech vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-74",
            name: "Nanotechnology",
            description: "Nanoscale science and materials terms",
            vocabularies: [],
          },
          {
            id: "b2-75",
            name: "Alternative Energy",
            description: "Clean energy and power generation vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-76",
            name: "Waste Management",
            description: "Recycling and waste treatment terminology",
            vocabularies: [],
          },
          {
            id: "b2-77",
            name: "Conservation",
            description: "Wildlife and habitat protection terms",
            vocabularies: [],
          },
          {
            id: "b2-78",
            name: "Marine Biology",
            description: "Ocean life and marine science vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-79",
            name: "Meteorology",
            description: "Weather patterns and atmospheric science terms",
            vocabularies: [],
          },
          {
            id: "b2-80",
            name: "Geology",
            description: "Earth structure and mineral science vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-81",
            name: "Pharmacology",
            description: "Drug development and medication terms",
            vocabularies: [],
          },
          {
            id: "b2-82",
            name: "Dentistry",
            description: "Dental care and oral health terminology",
            vocabularies: [],
          },
          {
            id: "b2-83",
            name: "Veterinary Science",
            description: "Animal health and veterinary terms",
            vocabularies: [],
          },
          {
            id: "b2-84",
            name: "Physical Therapy",
            description: "Rehabilitation and movement therapy vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-85",
            name: "Mental Health",
            description: "Psychological disorders and treatment terms",
            vocabularies: [],
          },
          {
            id: "b2-86",
            name: "Alternative Medicine",
            description: "Holistic healing and natural medicine vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-87",
            name: "Nutrition",
            description: "Diet and nutritional science terminology",
            vocabularies: [],
          },
          {
            id: "b2-88",
            name: "Fitness",
            description: "Exercise and physical fitness terms",
            vocabularies: [],
          },
          {
            id: "b2-89",
            name: "Sports Management",
            description: "Sports organization and administration vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-90",
            name: "Special Education",
            description: "Learning disabilities and special needs terms",
            vocabularies: [],
          },
          {
            id: "b2-91",
            name: "Early Childhood",
            description: "Child development and early education vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-92",
            name: "Distance Learning",
            description: "Online education and remote learning terms",
            vocabularies: [],
          },
          {
            id: "b2-93",
            name: "Career Counseling",
            description: "Career development and guidance vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-94",
            name: "Social Work",
            description: "Community service and social welfare terms",
            vocabularies: [],
          },
          {
            id: "b2-95",
            name: "Public Policy",
            description: "Policy making and governance vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-96",
            name: "Urban Studies",
            description: "City development and urban sociology terms",
            vocabularies: [],
          },
          {
            id: "b2-97",
            name: "Gender Studies",
            description: "Gender identity and equality vocabulary",
            vocabularies: [],
          },
          {
            id: "b2-98",
            name: "Cultural Studies",
            description: "Cultural theory and analysis terminology",
            vocabularies: [],
          },
          {
            id: "b2-99",
            name: "Media Studies",
            description: "Mass media and communication theory terms",
            vocabularies: [],
          },
          {
            id: "b2-100",
            name: "Digital Culture",
            description: "Internet culture and digital society vocabulary",
            vocabularies: [],
          },
        ],
      },
  ...
  static getLessonCategory(categoryId) {
    return this.getLessonCategories().find((cat) => cat.id === categoryId);
  }

  static getSubLesson(categoryId, subLessonId) {
    const category = this.getLessonCategory(categoryId);
